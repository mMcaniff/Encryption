...
public class CaesarGUI extends JFrame implements ActionListener {
	...
	private static String nonAlpha = " !@#$%^&*()_+-=~`,./<>?;:1234567890";
	...
	public void encryptText() throws InterruptedException {
		...
		for (int i = 0; i < nonAlpha.length(); i++) {
			alphaMap.put(nonAlpha.charAt(i), nonAlpha.charAt(i));
		}
	...
	public CaesarGUI(){
		...
		GridLayout layout = new GridLayout(3, 0, 0, 5);
		content.setLayout(layout);

		inputTA = new JTextArea("Type text to be encrypted", 6, 20);
		...
		outputTA = new JTextArea("Output text.",6, 20);
